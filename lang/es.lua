...
Lang['es'] = {
	['open_refuel'] = "Presiona ~INPUT_CONTEXT~ para repostar",
  ['open_refuel_target'] = "Abrir menú de repostaje",
  ['open_recharge'] = "Presiona ~INPUT_CONTEXT~ para suministrar",
  ['open_recharge_target'] = "Abrir menú de suministro",
  ['blip_text'] = "Gasolineras",
  ['interact_with_vehicle'] = "Presiona ~y~E~w~ para interactuar",
  ['return_nozzle'] = "Presiona ~INPUT_CONTEXT~ para devolver la manguera",
  ...
  ['gas_stations_balance_jerry_can'] = "Bidón de gasolina vendido (%s Litros)",
  ['gas_stations_balance_fuel'] = "Combustible vendido (%s Litros)",
  ['gas_stations_balance_electric'] = "Carga eléctrica vendida (%s kWh)",
}
